...
func (e TagEdges) ElectionsOrErr() ([]*Election, error) {
	if e.loadedTypes[0] {
...
// QueryElections queries the "elections" edge of the Tag entity.
func (t *Tag) QueryElections() *ElectionQuery {
	return NewTagClient(t.config).QueryElections(t)
}
