...
func (rq *ResultQuery) Order(o ...result.OrderOption) *ResultQuery {
...
func (rq *ResultQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (rq *ResultQuery) Clone() *ResultQuery {
	...
	return &ResultQuery{
		config:     rq.config,
		ctx:        rq.ctx.Clone(),
		order:      append([]result.OrderOption{}, rq.order...),
