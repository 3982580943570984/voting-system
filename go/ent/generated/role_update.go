...
func (ru *RoleUpdate) SetIsVoter(b bool) *RoleUpdate {
	ru.mutation.SetIsVoter(b)
	return ru
}

// SetNillableIsVoter sets the "is_voter" field if the given value is not nil.
func (ru *RoleUpdate) SetNillableIsVoter(b *bool) *RoleUpdate {
	if b != nil {
		ru.SetIsVoter(*b)
	}
	return ru
...
func (ru *RoleUpdate) SetIsOrganizer(b bool) *RoleUpdate {
	ru.mutation.SetIsOrganizer(b)
	return ru
}

// SetNillableIsOrganizer sets the "is_organizer" field if the given value is not nil.
func (ru *RoleUpdate) SetNillableIsOrganizer(b *bool) *RoleUpdate {
	if b != nil {
		ru.SetIsOrganizer(*b)
	}
	return ru
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ru.mutation.IsVoter(); ok {
		_spec.SetField(role.FieldIsVoter, field.TypeBool, value)
	}
	if value, ok := ru.mutation.IsOrganizer(); ok {
...
// SetIsVoter sets the "is_voter" field.
func (ruo *RoleUpdateOne) SetIsVoter(b bool) *RoleUpdateOne {
	ruo.mutation.SetIsVoter(b)
	return ruo
}

// SetNillableIsVoter sets the "is_voter" field if the given value is not nil.
func (ruo *RoleUpdateOne) SetNillableIsVoter(b *bool) *RoleUpdateOne {
	if b != nil {
		ruo.SetIsVoter(*b)
	}
	return ruo
...
// SetIsOrganizer sets the "is_organizer" field.
func (ruo *RoleUpdateOne) SetIsOrganizer(b bool) *RoleUpdateOne {
	ruo.mutation.SetIsOrganizer(b)
	return ruo
}

// SetNillableIsOrganizer sets the "is_organizer" field if the given value is not nil.
func (ruo *RoleUpdateOne) SetNillableIsOrganizer(b *bool) *RoleUpdateOne {
	if b != nil {
		ruo.SetIsOrganizer(*b)
	}
	return ruo
}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if value, ok := ruo.mutation.IsVoter(); ok {
		_spec.SetField(role.FieldIsVoter, field.TypeBool, value)
	}
	if value, ok := ruo.mutation.IsOrganizer(); ok {
		_spec.SetField(role.FieldIsOrganizer, field.TypeBool, value)
	}
