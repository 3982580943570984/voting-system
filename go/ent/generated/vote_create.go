...
func (vc *VoteCreate) SetIsActive(b bool) *VoteCreate {
	vc.mutation.SetIsActive(b)
	return vc
}

// SetNillableIsActive sets the "is_active" field if the given value is not nil.
func (vc *VoteCreate) SetNillableIsActive(b *bool) *VoteCreate {
	if b != nil {
		vc.SetIsActive(*b)
	}
	return vc
...
func (vc *VoteCreate) SetCandidateID(id int) *VoteCreate {
	vc.mutation.SetCandidateID(id)
	return vc
}

// SetNillableCandidateID sets the "candidate" edge to the Candidate entity by ID if the given value is not nil.
func (vc *VoteCreate) SetNillableCandidateID(id *int) *VoteCreate {
	if id != nil {
		vc = vc.SetCandidateID(*id)
	}
	return vc
}

// SetCandidate sets the "candidate" edge to the Candidate entity.
func (vc *VoteCreate) SetCandidate(c *Candidate) *VoteCreate {
	return vc.SetCandidateID(c.ID)
}
...
func (vc *VoteCreate) createSpec() (*Vote, *sqlgraph.CreateSpec) {
	...
	if nodes := vc.mutation.CandidateIDs(); len(nodes) > 0 {
