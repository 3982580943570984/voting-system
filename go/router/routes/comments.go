...
func CommentsRoutes() chi.Router {
	r := chi.NewRouter()
...
func createComment(w http.ResponseWriter, r *http.Request) {
	...
	comment, err := services.NewComments().Create(r.Context(), &cc)
	if err != nil {
...
func getAllCommentsByElectionId(w http.ResponseWriter, r *http.Request) {
	...
	comments, err := services.NewComments().GetAllByElectionId(r.Context(), electionId)
	if err != nil {
		http.Error(w, "Internal server error: "+err.Error(), http.StatusInternalServerError)
		return
	}
